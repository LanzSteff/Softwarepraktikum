...
public class MainViewPanel extends JFrame{
	...
	private JButton m_connectButton2 = new JButton("Connect Ports");
	...
	private JMenuItem m_ConnectPorts = new JMenuItem("Connect Ports");
	private JMenuItem m_DisconnectPorts = new JMenuItem("Disconnect Ports");
	...
	private JTextField m_sendValue;
    ...
    JMenu m_compMenu = new JMenu("Component");
    ...
    JDialog m_dialog6;
    JDialog m_dialog7;
    JDialog m_connectDialog1;
    JDialog m_sendDialog1;
    JDialog m_receiveDialog1;
    
    JTextArea receiveArea = new JTextArea(10, 25);
	...
	public MainViewPanel()
	{
		...
		m_connectDialog1 = new JDialog();
		m_sendDialog1 = new JDialog();
		m_receiveDialog1 = new JDialog();
		...
		cs8.gridwidth = 2;
		cs8.gridheight = 1;
		m_d8Panel.add(m_connectButton2, cs8);
		m_connectDialog1.setContentPane(m_d8Panel);
		m_connectDialog1.pack();
		
		
		JPanel m_d9Panel = new JPanel();
		m_d9Panel.setLayout(new GridBagLayout());
		GridBagConstraints cs9 = new GridBagConstraints();
		cs9.gridx = 0;
		cs9.gridy = 0;
		cs9.gridwidth = 2;
		m_d9Panel.add(m_sendValue);
		cs9.gridx = 0;
		cs9.gridy = 1;
		cs9.gridwidth = 2;
		m_d9Panel.add(m_sendButton, cs9);
		m_sendDialog1.setContentPane(m_d9Panel);
		m_sendDialog1.pack();
		
		JPanel m_d10Panel = new JPanel();
		m_d10Panel.setLayout(new GridBagLayout());
		GridBagConstraints cs10 = new GridBagConstraints();
		JScrollPane m_ScrollPane7 = new JScrollPane(receiveArea);
		cs10.gridx = 0;
		cs10.gridy = 0;
		m_d10Panel.add(m_ScrollPane7);
		m_receiveDialog1.setContentPane(m_d10Panel);
		m_receiveDialog1.pack();
	    ...
	    m_compMenu.add(m_AddComponent);
		m_compMenu.add(m_RemoveComponent);
		m_compMenu.addSeparator();
		m_compMenu.add(m_EditComponent);
		m_compMenu.addSeparator();
		m_compMenu.add(m_send);
		m_compMenu.add(m_receive);
	    
	    //m_editMenu.add(m_EditComponent);
	    
	    m_portMenu.add(m_PortList);
	    m_portMenu.addSeparator();
	    m_portMenu.add(m_ConnectPorts);
	    m_portMenu.add(m_DisconnectPorts);
	...
	{
		m_receiveDialog1.setVisible(true);
	}
	
	public void hideReceiveDialog()
	{
		m_receiveDialog1.setVisible(false);
	}
	
	public void showSendDialog()
	{
		m_sendDialog1.setVisible(true);
	}
	
	public void hideSendDialog()
	{
		m_sendDialog1.setVisible(false);
	}
	...
	public int getSelectedValueList5()
	{
		return Integer.parseInt((String)m_List5.getSelectedValue());
	}
	
	public int getSelectedValueList6()
	{
		return Integer.parseInt((String)m_List6.getSelectedValue());
	}
	...
	public void showConnectDialog1()
	{
		m_connectDialog1.setVisible(true);
	}
	
	public void hideConnectDialog1()
	{
		m_connectDialog1.setVisible(false);
	}
	
	// Listener Interfaces
	/*public void addSendButtonListener1(ActionListener aListener) 
	{
		m_connectButton2.addActionListener(aListener);
    }*/
	
	public void addConnectPortListener1(ActionListener aListener) 
	{
		m_ConnectPorts.addActionListener(aListener);
    }
	
	public void addConnectPortListener2(ActionListener aListener) 
	{
		m_connectButton2.addActionListener(aListener);
    }
	...
	private class MouseHandler implements MouseListener, MouseMotionListener{
		...
		public void mouseClicked(MouseEvent e) {
	        ...
	        {
	        	if(path != null &&
	        			e.isPopupTrigger()) m_compMenu.show(MainViewPanel.this, e.getX(), e.getY());
	        }
